# granular_tessellation_anisotropy
This contains data used in the manuscript: "Preserving elastic anisotropy with tessellations of granular packings"

The data is separated into four different folders
1) crystals (contains elastic tensors for DFT crystal database and derived crystalline spring networks)
2) pbc (contains elastic tensors for granular packings in periodic boundary conditions)
